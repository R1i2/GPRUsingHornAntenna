...
<MetaResultFile creator="FE Port mode solver" version="20170330">
  ...
  <ResultGroups num_steps="1">
    <Frame index="0" characteristic="9.9999999999999982236" tfo="Port1_h1_pmm_10.tfo">
      <FieldResultFile filename="Port1_h1[10].prt" meshname="Port1_h1_pmm.slim" type="prt"/>
    </Frame>
  </ResultGroups>
